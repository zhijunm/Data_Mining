setwd("C:/Users/mazhi/Documents/R/560 data mining")
...
housing.df[s,]
c <- sample(names(housing.df), 5) # sample 5 columns
housing.df[,c]

#### Table 2.5

names(housing.df)  # print a list of variables to the screen.
t(t(names(housing.df)))  # print the list in a useful column format, t=matrix transpose
